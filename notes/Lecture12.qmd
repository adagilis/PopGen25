...
## Example
:::{layout-ncol=2}
![](images/paste-43.png){width="350"}

![](images/paste-44.png){width="350"}
:::
## DAPC
...
- t-SNE when data highly multi-dimensional _and_ there are many true clusters, but you don't need axes to mean anything
...
plot(admix,coordinates,method="map.max",interpol=FieldsKrigModel(10),col.palette=my.palette)
```
