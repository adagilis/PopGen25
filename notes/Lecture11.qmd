...
Early approaches focused on identifying heterozygosity and the implied effective population size (worries about inbreeding depression go all the way back to Darwin).
...
The goal of many studies was therefore to initially estimate $N_E$
...
In a classic paper [@Lynch1995] showed how the ecological parameters of a population (carrying capacity and reproductive rate) directly tied to its long term $N_E$ and, in turn, extinction probability.
...
The numbers used here were exceedingly small - carrying capacities of 150 were considered "large" populations.

## One example - deer in UT Austin

Brackenridge field lab is fully enclosed by \~12 ft fencing.

. . .

1982 a pregnant white-tailed doe manages to cross over, fleeing from coyotes. Gives birth to two males.

. . .

By early 2000s - \~40 deer in the fenced area.

. . .

By my graduate studies in 2013-2019: down to four individuals.

. . .

Males with increasingly strange horns, females rarer and rarer.
...
Why not sequence all nuclear DNA?

## More modern approaches - more sequencing {.smaller}
...
One way to measure how diversity is distributed in your own data is to just look at genetic diversity across space. (See `EEMS` or `wingen`).
...
But, what can create an illusion of increased genetic diversity?
