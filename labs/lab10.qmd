...
This should generate the psmc requisite file for your sequence.

#### If you want to run on own data
 In your own data, you can use a slightly different approach if you have the raw reads for your sample. Once you have aligned them, you can then run:
...
awk 'BEGIN{printf "smc++ vcf2smc subsampled_chr22.vcf.gz chr22.smc.gz 22 Pop1:"};$4=="FIN"{printf $1","}' samples_for_introgression.txt
```
